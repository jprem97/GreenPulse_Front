const FullLogo = ({ size = 80, className = '' }) => {
  return (
    <div className={className} style={{
      ...
      >
        <defs>
          <linearGradient id="fl-bg" x1="0" y1="0" x2="128" y2="128">
            <stop offset="0%" stopColor="#10b981" />
            <stop offset="100%" stopColor="#047857" />
          </linearGradient>
          <linearGradient id="fl-helmet" x1="32" y1="10" x2="96" y2="110">
            <stop offset="0%" stopColor="#34d399" />
            <stop offset="60%" stopColor="#10b981" />
            <stop offset="100%" stopColor="#059669" />
          </linearGradient>
          <linearGradient id="fl-leaf" x1="44" y1="0" x2="84" y2="20">
            <stop offset="0%" stopColor="#6ee7b7" />
            <stop offset="100%" stopColor="#10b981" />
          </linearGradient>
        </defs>

        <rect width="128" height="128" rx="24" fill="url(#fl-bg)" />
        ...
        <path d="M64 16 Q84 2, 94 16 Q82 8, 64 16" fill="url(#fl-leaf)" />
        <path d="M64 16 Q44 2, 34 16 Q46 8, 64 16" fill="url(#fl-leaf)" opacity="0.85" />
